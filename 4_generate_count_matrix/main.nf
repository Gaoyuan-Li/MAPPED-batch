...
process DATA_VALIDATION {
    ...
    output:
      ...
      path 'log_tpm_norm.csv', emit: log_tpm_norm, optional: true
...
# Handle optional log_tpm_norm
log_tpm_norm_file = '${log_tpm_norm_matrix}'
if log_tpm_norm_file and log_tpm_norm_file != 'null':
    matrix_files['log_tpm_norm.csv'] = log_tpm_norm_file
...
workflow {
    ...
    // Skip normalization for batch processing - will be done after merging
    ...
    validated_results = DATA_VALIDATION(
        ...
        Channel.empty()  // Pass empty channel for log_tpm_norm
    )
}
